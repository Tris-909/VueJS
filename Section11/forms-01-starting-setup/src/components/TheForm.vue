<template>
  <form @submit.prevent="submitForm">
    <div class="form-control">
      ...
      <input id="user-name" :class="{invalid: invalidUsername == 'invalid'}" name="user-name" type="text" v-model.trim="username" @blur="validateInput" />
      <p style="color: red" v-if="invalidUsername == 'invalid'"> Invalid User Name </p>
    </div>
    <div class="form-control">
...
<script>
import Rating from './RatingControl';
